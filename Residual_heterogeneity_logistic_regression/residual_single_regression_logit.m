function [result] = residual_single_regression_logit(x, y, sample_size, row_size, col_size, beta_real, gamma_real,...
...
[beta_back, gamma_back, ~] = matrix_homogeneity_regression_logit(x, y, index_store, sample_size, row_size, col_size, eps_initial, iter_max_initial_in,...
...
X = blkdiag(x_cell{:});
eta = D_beta*X*gamma_back;
residual = -(y.*eta-log(1+exp(eta)));
