function [Result_table, Result_table_summary] = RESIDUAL_logit(simulation_size, Data_x, y_real, sample_size, row_size, col_size, beta_real, gamma_real,...
...
%-------------------------------------使用方法----------------------------------------%
% [Result_table, Result_table_summary] = RESIDUAL_logit(simulation_size, Data_x, y_real,...
...
for i = 1:simulation_size
    y = y_real(:, i);
    x = Data_x(:,:,:,i);
    [result] = residual_single_regression_logit(x, y, sample_size, row_size, col_size, beta_real, gamma_real,...
